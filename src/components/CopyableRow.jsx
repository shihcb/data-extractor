...
export default function CopyableRow({ label, value, highlight = false, onCopy }) {
  ...
  return (
    <div
      onClick={handleCopy}
      className={`group cursor-pointer inset-shape p-4 transition-all duration-150 hover:border-slate-400 hover:shadow-sm flex items-center justify-between gap-4 ${
